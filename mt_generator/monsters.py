...
monsters = [
    ...
    [ # section 3
        ...
        _MonsterCreator(GhostSoldier,220,150,40,40,3,3,3),
        _MonsterCreator(SandMan,450,180,10,50,3,5,6),
        _MonsterCreator(Soldier,200,190,55,49,3,5,5),
        _MonsterCreator(GateKeeperB,100,180,120,57,3,8,6),
        _MonsterCreator(SwordsmanB,95,680,50,60,3,7,4),
        _MonsterCreator(KnightB,180,210,110,75,3,9,8),
    ],
    [ # section 4
        _MonsterCreator(GreenSlimeA,350,280,10,52,4,1,2),
        _MonsterCreator(VampireBatB,200,370,80,58,4,2,2),
        _MonsterCreator(MagicianB,220,360,100,78,4,4,3),
        _MonsterCreator(MagicianA,250,400,110,92,4,6,5),
        _MonsterCreator(MagicSergeantB,440,380,65,95,4,5,6),
        _MonsterCreator(DarkKnightB,180,410,200,110,4,8,7),
        _MonsterCreator(GateKeeperA,170,385,230,160,4,10,9),
    ],
    [ # section 5
        _MonsterCreator(RedSlimeA,550,320,110,90,5,1,0),
        _MonsterCreator(Slimelord,500,360,140,100,5,3,2),
        _MonsterCreator(DarkPriest,250,444,200,110,5,5,4),
        _MonsterCreator(KnightA,400,400,230,125,5,6,4),
        _MonsterCreator(SmokeMan,500,450,165,133,5,5,5),
        _MonsterCreator(FireBat,330,600,80,130,5,3,5),
...
bosses = [
    _MonsterCreator(SkeletonA,111,80,25,100,1),
    _MonsterCreator(Vampire,444,199,55,216,2),
