...
monsters = [
    [ # section 1
        _MonsterCreator(GreenSlimeB,35,18,1,8,1,1,1),
    ...
    [ # section 5
        _MonsterCreator(RedSlimeA,550,310,100,90,5,1,1),
